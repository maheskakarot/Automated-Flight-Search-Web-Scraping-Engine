...
#     SearchFlightView
from v3.ryanair.views import SearchFlightUpdatedViewV3, ApiRepriceValidationView, SearchFlightView
...
urlpatterns = [
    ...
    path('search/search_flights', SearchFlightUpdatedViewV3.as_view()),
    path('reprice/validation', ApiRepriceValidationView.as_view(), name="reprice_validation"),
